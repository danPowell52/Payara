 ...
 * 
 */
@WebServiceClient(name = "AddNumbersService", targetNamespace = "http://server.fromjava/", wsdlLocation = "http://localhost:5080/JaxwsFromJava/AddNumbersService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:5080/JaxwsFromJava/AddNumbersService?wsdl");
