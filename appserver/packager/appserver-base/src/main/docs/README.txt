...
Payara Server 4.1.1.163 requires Oracle JDK 7 Update 65+ or Oracle JDK 8 Update 5+. 
...
Make sure to also check the Payara Server 4.1.1.163 Release Notes as they contain important information: https://github.com/payara/Payara/wiki/Release-Notes-(Payara-4.1.1.163)


5. Documentation 
================

Payara Server 4.1.1.163 Release Notes: https://github.com/payara/Payara/wiki/Release-Notes-(Payara-4.1.1.163)
