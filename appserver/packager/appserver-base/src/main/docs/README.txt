Thank you for downloading Payara Blue Server 4.1.1.163!
...
Payara Blue Server 4.1.1.163 requires IBM JDK Version 7, SR9 FP40 or higher, IBM JDK Version 7 Release 1, SR3 FP40 or higher or IBM JDK Version 8 SR3 or higher. 
...
Make sure to also check the Payara Blue Server 4.1.1.163 Release Notes as they contain important information: https://github.com/payara/Payara/wiki/Release-Notes-(Payara-4.1.1.163)


5. Documentation 
================

Payara Blue Server 4.1.1.163.163 Releases Notes: https://github.com/payara/Payara/wiki/Release-Notes-(Payara-4.1.1.163)
